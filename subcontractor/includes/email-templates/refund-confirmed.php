<?php
/**
 * Refund Confirmed Email Template
 * Sent to both vendor and organizer when a refund has been processed.
 *
 * Variables available:
...
<head>
    ...
    <title>Refundering bekræftet</title>
</head>
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 560px; margin: 0 auto;">
                    ...
                    <tr>
                        <td style="text-align: center; padding-bottom: 24px;">
                            <div style="display: inline-block; padding: 10px 20px; background-color: <?= $infoBlue ?>; border-radius: 8px;">
                                <span style="color: #ffffff; font-size: 13px; font-weight: 600; letter-spacing: 0.05em; text-transform: uppercase;">
                                    Refundering bekræftet
                                </span>
                            </div>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td style="padding: 44px 40px;">
                                        ...
                                        <h1 style="margin: 0 0 16px; font-size: 26px; font-weight: 600; color: <?= $charcoal ?>; line-height: 1.3;">
                                            Refundering er gennemført
                                        </h1>

                                        <p style="margin: 0 0 28px; font-size: 16px; line-height: 1.7; color: #555555;">
                                            <?php if ($isVendor): ?>
                                                Depositum for bookingen med <strong><?= htmlspecialchars($booking['account_name'] ?? 'arrangøren') ?></strong><?php if (!empty($booking['event_title'])): ?> til <strong><?= htmlspecialchars($booking['event_title']) ?></strong><?php endif; ?> er blevet refunderet til arrangøren.
                                            <?php else: ?>
                                                Depositum for din booking med <strong><?= htmlspecialchars($booking['vendor_company_name'] ?? 'leverandøren') ?></strong><?php if (!empty($booking['event_title'])): ?> til <strong><?= htmlspecialchars($booking['event_title']) ?></strong><?php endif; ?> er blevet refunderet.
                                                Beløbet vil typisk blive tilbagebetalt inden for 5-10 bankdage.
                                            <?php endif; ?>
                                        </p>
                                            ...
                                            <tr>
                                                <td style="padding: 24px;">
                                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <strong style="font-size: 11px; text-transform: uppercase; letter-spacing: 0.1em; color: <?= $sageGreen ?>;">Refunderet beløb</strong><br>
                                                                <span style="font-size: 18px; color: <?= $infoBlue ?>; font-weight: 700;">
                                        ...
                                        <?php if (!$isVendor): ?>
                                        <p style="margin: 0 0 28px; font-size: 14px; line-height: 1.7; color: #777777; padding: 14px 16px; background-color: #EBF5FB; border-radius: 8px;">
                                            Bemærk: Afhængigt af din bank kan det tage 5-10 bankdage, før beløbet er synligt på din konto.
                                        </p>
                                        <?php endif; ?>
