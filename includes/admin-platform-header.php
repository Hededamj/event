...
<body>
    ...
    <aside class="ds-sidebar" id="adminSidebar">
        ...
        <nav class="ds-sidebar-nav">
            ...
            <a href="<?= BASE_PATH ?>/admin-platform/agents.php" class="ds-nav-link <?= in_array($currentPage, ['agents', 'agent-detail']) ? 'active' : '' ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <a href="<?= BASE_PATH ?>/admin-platform/admins.php" class="ds-nav-link <?= $currentPage === 'admins' ? 'active' : '' ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
